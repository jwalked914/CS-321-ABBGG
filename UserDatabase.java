...
public class UserDatabase
{
    ...
    private String userXMLPath="usersInfo.xml";
     ...
     */
    public UserDatabase(GameDatabase gameDatabase)
    {
    ...
    {
        File xmlFile=new File(userXMLPath);
        if (!xmlFile.exists())
        {
    ...
    {
        User newUser=new User(username, password, isAdmin, new ArrayList<>());
    ...
    private void writeToXML()
    {
        try
        {
            ...
            for (User user: userList.values())
            {
                ...
                userElement.setAttribute("isAdmin", String.valueOf(user.isAdmin()));
