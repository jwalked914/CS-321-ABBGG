...
public class GameCard extends JPanel{
     ...
     * @param isCollection true if this card is displayed within a UserCollection, false for master database
     * @param user         the logged-in user, used for collection dialog
     * @param gameDB       the GameDatabase or UserCollection this card belongs to
